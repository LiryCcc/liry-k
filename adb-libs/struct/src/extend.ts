...
export function extend<
  Base extends Struct<StructFields, Record<PropertyKey, unknown> | undefined, unknown>,
  Fields extends StructFields,
  PostDeserialize = FieldsValue<Base['fields'] & Fields> & ExtraToIntersection<Base['extra']>
>(
  base: Base,
  fields: Fields,
  options?: {
    ...
    postDeserialize?: (
      this: FieldsValue<Base['fields'] & Fields> & ExtraToIntersection<Base['extra']>,
      value: FieldsValue<Base['fields'] & Fields> & ExtraToIntersection<Base['extra']>
    ) => PostDeserialize;
  }
