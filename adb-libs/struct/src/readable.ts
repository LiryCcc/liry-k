...
const ExactReadableEndedErrorBrand = Symbol.for('ExactReadableEndedError.brand');
...
export class ExactReadableEndedError extends Error {
  ...
  static override [Symbol.hasInstance](value: unknown) {
    return !!(value as ExactReadableEndedError | undefined)?.[ExactReadableEndedErrorBrand];
  }
