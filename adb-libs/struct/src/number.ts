import type { MaybePromiseLike } from '@liry-k/async';
import {
  getInt16,
  getInt32,
  getInt64,
  ...
  setUint32,
  setUint64
} from '@liry-k/no-data-view';

import type { Field, FieldByobSerializeContext, FieldDeserializeContext } from './field/index.js';
...
function number<T>(
  size: number,
  serialize: (source: T, context: FieldByobSerializeContext & { index: number }) => void,
  deserialize: (
