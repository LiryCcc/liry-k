export const getUint64LittleEndian = (buffer: Uint8Array, offset: number): bigint =>
...
export const getUint64BigEndian = (buffer: Uint8Array, offset: number): bigint =>
...
export const getUint64 = (buffer: Uint8Array, offset: number, littleEndian: boolean): bigint =>
  littleEndian
    ? BigInt(buffer[offset]!) |
      (BigInt(buffer[offset + 1]!) << 8n) |
      (BigInt(buffer[offset + 2]!) << 16n) |
...
export const setUint64LittleEndian = (buffer: Uint8Array, offset: number, value: bigint): void => {
...
export const setUint64BigEndian = (buffer: Uint8Array, offset: number, value: bigint): void => {
...
export const setUint64 = (buffer: Uint8Array, offset: number, value: bigint, littleEndian: boolean): void => {
  if (littleEndian) {
    buffer[offset] = Number(value & 0xffn);
    buffer[offset + 1] = Number((value >> 8n) & 0xffn);
    buffer[offset + 2] = Number((value >> 16n) & 0xffn);
