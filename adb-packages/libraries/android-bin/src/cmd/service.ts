import type { Adb, AdbNoneProtocolSpawner, AdbShellProtocolSpawner } from '@yume-chan/adb';
...
export namespace Cmd {
  export type Fallback = string | Record<string, string> | ((service: string) => string) | undefined;
