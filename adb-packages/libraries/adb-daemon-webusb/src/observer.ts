...
export class AdbDaemonWebUsbDeviceObserver implements DeviceObserver<AdbDaemonWebUsbDevice> {
  ...
  readonly #onDeviceAdd = new EventEmitter<readonly AdbDaemonWebUsbDevice[]>();
  onDeviceAdd = this.#onDeviceAdd.event;

  readonly #onDeviceRemove = new EventEmitter<readonly AdbDaemonWebUsbDevice[]>();
  onDeviceRemove = this.#onDeviceRemove.event;

  readonly #onListChange = new StickyEventEmitter<readonly AdbDaemonWebUsbDevice[]>();
