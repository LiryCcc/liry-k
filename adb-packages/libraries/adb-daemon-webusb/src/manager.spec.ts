...
class MockUsb implements USB {
  onconnect: (ev: USBConnectionEvent) => void = vi.fn();
  ondisconnect: (ev: USBConnectionEvent) => void = vi.fn();
...
describe('AdbDaemonWebUsbDeviceManager', () => {
  describe('requestDevice', () => {
    it('should accept 0 args', async () => {
      ...
      assert.strictEqual(usb.requestDevice.mock.calls.length, 1);
      assert.deepEqual(usb.requestDevice.mock.calls[0], [
        {
