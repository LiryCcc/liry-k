...
export class AdbScrcpyOptions3_3_3<TVideo extends boolean>
  ...
  implements AdbScrcpyOptions<ScrcpyOptions3_3_3.Init<TVideo>>, AdbScrcpyOptionsGetEncoders
{
...
export namespace AdbScrcpyOptions3_3_3 {
  export type Init<TVideo extends boolean = boolean> = ScrcpyOptions3_3_3.Init<TVideo>;
}
