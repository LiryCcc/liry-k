...
export namespace Consumable {
  ...
  export type WrapWritableStream<in T> = typeof ConsumableWrapWritableStream<T>;

  export type ReadableStreamController<T> = ConsumableReadableStreamController<T>;
  ...
  export type WrapByteReadableStream = typeof ConsumableWrapByteReadableStream;
}
