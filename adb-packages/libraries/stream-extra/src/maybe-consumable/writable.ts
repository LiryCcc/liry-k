...
import type { QueuingStrategy, WritableStreamDefaultController } from '../global/index.js';
...
export class MaybeConsumableWritableStream<in T> extends WritableStream<MaybeConsumable<T>> {
    ...
    super(
      {
        ...
        write(chunk, controller) {
          return tryConsume(chunk, (chunk) => sink.write?.(chunk as T, controller));
        },
        abort(reason) {
