...
type EventTargetConstructor = GlobalValueOr<'EventTarget', _EventTargetConstructor>;

export const EventTarget = getGlobalValue<EventTargetConstructor>('EventTarget');
