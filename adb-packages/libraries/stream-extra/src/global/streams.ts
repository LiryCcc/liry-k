...
export const ByteLengthQueuingStrategy =
  getGlobalValue<ByteLengthQueuingStrategyConstructor>('ByteLengthQueuingStrategy');
...
export const CountQueuingStrategy = getGlobalValue<CountQueuingStrategyConstructor>('CountQueuingStrategy');
...
export const ReadableStream = getGlobalValue<ReadableStreamConstructor>('ReadableStream');
...
export const ReadableStreamBYOBReader = getGlobalValue<ReadableStreamBYOBReaderConstructor>('ReadableStreamBYOBReader');
...
export const ReadableStreamDefaultReader =
  getGlobalValue<ReadableStreamDefaultReaderConstructor>('ReadableStreamDefaultReader');
...
export const TransformStream = getGlobalValue<TransformStreamConstructor>('TransformStream');
...
export const WritableStream = getGlobalValue<WritableStreamConstructor>('WritableStream');
...
export const WritableStreamDefaultWriter =
  getGlobalValue<WritableStreamDefaultWriterConstructor>('WritableStreamDefaultWriter');
