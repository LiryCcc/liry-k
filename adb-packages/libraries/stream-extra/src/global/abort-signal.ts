...
type AbortSignalConstructor = GlobalValueOr<'AbortSignal', _AbortSignalConstructor>;

export const AbortSignal = getGlobalValue<AbortSignalConstructor>('AbortSignal');
...
export type AbortController = GlobalPrototypeOr<'AbortController', _AbortController>;
...
type AbortControllerConstructor = GlobalValueOr<'AbortController', _AbortControllerConstructor>;

export const AbortController = getGlobalValue<AbortControllerConstructor>('AbortController');
