...
export class ScrcpyVideoDecoderPauseController
  extends TransformStream<ScrcpyVideoDecoderPauseController.Input, ScrcpyVideoDecoderPauseController.Output>
...
export namespace ScrcpyVideoDecoderPauseController {
  ...
  export type Output =
    ScrcpyMediaStreamConfigurationPacket | (ScrcpyMediaStreamDataPacket & { skipRendering: boolean });
}
