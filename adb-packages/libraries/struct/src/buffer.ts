import type { BipedalFieldDeserializer, ByobFieldSerializer, Field } from './field/index.js';
import { field } from './field/index.js';

export const EmptyUint8Array = new Uint8Array(0);

function copyMaybeDifferentLength(dest: Uint8Array, source: Uint8Array, index: number, length: number) {
 ...
 */
export function buffer(length: number): Field<Uint8Array, never, never, Uint8Array>;
/**
 ...
 */
export function buffer<U>(length: number, converter: Converter<Uint8Array, U>): Field<U, never, never, Uint8Array>;
 ...
 */
export function buffer<K extends string>(lengthField: K): Field<Uint8Array, K, Record<K, number>, Uint8Array>;
/**
...
export function buffer(
  lengthOrField: string | number | Field<number, string, unknown, number> | BufferLengthConverter<string, unknown>,
  ...
  if (typeof lengthOrField === 'string') {
    let deserialize: BipedalFieldDeserializer<unknown, Record<string, unknown>>;
    let init: (value: unknown, dependencies: Record<string, unknown>) => Uint8Array;
