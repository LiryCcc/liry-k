...
export class AdbDaemonTransport implements AdbTransport {
  ...
  constructor({
    ...
    if (!this.#banner.features.includes(AdbFeature.DelayedAck) || !features.includes(AdbFeature.DelayedAck)) {
