...
import { AdbDaemonAuthType, AdbDaemonDefaultAuthProcessor } from './packet-processor.js';
...
describe('auth', () => {
  describe('AdbDaemonAuthProcessor', () => {
    it('should generate correct public key without name', async () => {
      const store = new MockCredentialManager(new Uint8Array(PRIVATE_KEY), undefined);
    ...
    it('should generate correct public key name', async () => {
      ...
      const store = new MockCredentialManager(new Uint8Array(PRIVATE_KEY), name);
