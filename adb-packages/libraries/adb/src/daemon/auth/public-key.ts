...
export function adbGeneratePublicKey(privateKey: SimpleRsaPrivateKey): Uint8Array<ArrayBuffer>;
export function adbGeneratePublicKey(privateKey: SimpleRsaPrivateKey, output: Uint8Array): number;
export function adbGeneratePublicKey(privateKey: SimpleRsaPrivateKey, output?: Uint8Array): Uint8Array | number {
...
export function adbGetPublicKeyFingerprint(key: AdbPrivateKey | Uint8Array): string {
  if ('d' in key) {
