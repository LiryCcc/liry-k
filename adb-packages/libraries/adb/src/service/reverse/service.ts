...
import { AdbReverseErrorResponse, AdbReverseStringResponse } from './response.js';
...
export class AdbReverseService {
   ...
   */
  async add(deviceAddress: string, handler: Adb.IncomingSocketHandler, localAddress?: string): Promise<string> {
