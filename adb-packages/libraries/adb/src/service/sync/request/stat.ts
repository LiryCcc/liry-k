...
export function lstatV1(pool: SocketPool, path: string): Promise<LstatResponse> {
...
export async function lstat(pool: SocketPool, path: string, { version }: { version: 1 | 2 }): Promise<Stat> {
  if (version === 2) {
