...
export async function* generator(pool: SocketPool, path: string): AsyncGenerator<Uint8Array, void, void> {
...
export function stream(pool: SocketPool, path: string): ReadableStream<Uint8Array> {
