import { getUint32LittleEndian, setUint32LittleEndian, setUint64LittleEndian } from '@yume-chan/no-data-view';
...
export class Md5 {
  ...
  digest() {
    ...
    setUint64LittleEndian(this.#buffer, this.#buffer.length - 8, this.#length << 3n);
    this.#update(this.#buffer);
