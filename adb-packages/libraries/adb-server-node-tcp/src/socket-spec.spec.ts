...
describe('parseTcpSocketSpec', () => {
  ...
  it('host ipv6 bad ports failure', () => {
    assert.throws(() => parseTcpSocketSpec('2601:644:8e80:620:c63:50c9:8a91:8efa::'));
    assert.throws(() => parseTcpSocketSpec('2601:644:8e80:620:c63:50c9:8a91:8efa::-1'));
    assert.throws(() => parseTcpSocketSpec('2601:644:8e80:620:c63:50c9:8a91:8efa::65536'));
  });
  ...
  it('ipv6 and port success', () => {
    ...
    assert.deepStrictEqual(parseTcpSocketSpec('[2601:644:8e80:620::fbbc]:2345'), {
  ...
  it('ipv6 no port success', () => {
    ...
    assert.deepStrictEqual(parseTcpSocketSpec('2601:644:8e80:620:c63:50c9:8a91:8efa'), {
      host: '2601:644:8e80:620:c63:50c9:8a91:8efa'
    });
    assert.deepStrictEqual(parseTcpSocketSpec('2601:644:8e80:620:2d0e:b944:5288:97df'), {
  ...
  it('ipv6 bad ports failure', () => {
    ...
    assert.throws(() => parseTcpSocketSpec('2601:644:8e80:620:2d0e:b944:5288:97df:-1'));
    assert.throws(() => parseTcpSocketSpec('2601:644:8e80:620:2d0e:b944:5288:97df:65536'));
  });
});
