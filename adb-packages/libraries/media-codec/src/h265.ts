 ...
 */
export function parseVuiParameters(reader: NaluSodbBitReader, sps_max_sub_layers_minus1: number) {
 ...
 */
export function parseSubLayerHrdParameters(reader: NaluSodbBitReader, subLayerId: number, CpbCnt: number) {
...
export function parseConfiguration(data: Uint8Array): Configuration {
  const { videoParameterSet, sequenceParameterSet, pictureParameterSet } = searchConfiguration(data);
